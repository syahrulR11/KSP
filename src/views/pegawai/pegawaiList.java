 ...
 * @author syahrul
 */
public class pegawaiList extends javax.swing.JFrame {
    private DatabaseManager dbManager;
    private DMLSQL dmlSql;
    private DefaultTableModel tableModel;

    /**
     * Creates new form pegawaiList
     */
    public pegawaiList() {
        initComponents();
    ...
    void datatable() {
        Object[] Baris = {"ID","Nama","Email","No. Telp","Jenis Kelamin","Alamat","Jabatan"};
        tableModel = new DefaultTableModel(null,Baris);
        String search = cariInput.getText();
        try {
            String[] columnsToSelect = {"pegawai.id","pegawai.nama","pegawai.email","pegawai.no_telp","pegawai.jenis_kelamin","pegawai.alamat","jabatan.nama"};
    ...
    private void initComponents() {
        ...
        setTitle("KSP Idol | Pegawai Manajemen");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        title.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        title.setText("Pegawai Manajemen");
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {                                          
        JDialog dialog = new JDialog(this, "KSP Idol | Tambah Pegawai", true);
        pegawaiForm pegawaiCreate = new pegawaiForm(dialog, null);
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        datatable();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        JDialog dialog = new JDialog(this, "KSP Idol | Detail Pegawai", true);
        pegawaiForm pegawaiCreate = new pegawaiForm(dialog, id);
        dialog.getContentPane().add(pegawaiCreate);
        dialog.pack();
        dialog.setLocationRelativeTo(this);
        dialog.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pegawaiList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pegawaiList().setVisible(true);
            }
        });
    }
